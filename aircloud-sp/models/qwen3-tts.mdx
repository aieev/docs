...
<Info>
  **Model ID:** `qwen/qwen3-tts-customvoice` | **Endpoint ID:** `qwen3-tts` | **Parameters:** 1.7B | **Released:** 2026-01-22
</Info>

| Input Price | Output Price | Languages | Voices |
| :-: | :-: | :-: | :-: |
| $0.080 / 1K chars | $0.000 | EN · ZH · JA · KO | 9 presets + custom |
...
<CardGroup cols={3}>
  <Card title="Air API Playground" icon="play" href="https://ap-1.aieev.cloud:3000/models/qwen%2Fqwen3-tts-customvoice">
...
TTS models are billed by **input characters**, not tokens.

| Currency | Input (1,000 characters) | Output |
| :-- | --: | --: |
| USD | $0.080 | $0.000 |
| KRW | ₩116 | ₩0 |
