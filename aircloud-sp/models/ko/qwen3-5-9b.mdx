...
<Info>
  **모델 ID:** `qwen/qwen3.5-9b` | **엔드포인트 ID:** `qwen3-5-9b` | **파라미터:** 9B | **출시일:** 2026-03-10
</Info>

| 입력 가격 | 출력 가격 | 컨텍스트 | 모달리티 | 양자화 |
| :-: | :-: | :-: | :-: | :-: |
| $0.100 / 1M | $0.150 / 1M | 262,144 | 텍스트 + 이미지 → 텍스트 | FP8 |
...
<CardGroup cols={3}>
  <Card title="Air API Playground" icon="play" href="https://ap-1.aieev.cloud:3000/ko/models/qwen%2Fqwen3.5-9b">
    플레이그라운드에서 모델을 체험하세요.
  </Card>
...
| [Vision](/docs/ko/air-api/openai-compatible-api#vision-이미지-입력) | ✅ | 요청당 이미지 최대 1장 |
