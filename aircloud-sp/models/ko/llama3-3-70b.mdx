...
<Info>
  **모델 ID:** `llama3.3-70b-instruct` | **엔드포인트 ID:** `llama3-3-70b` | **파라미터:** 70B | **출시일:** 2024-12-06
</Info>

| 입력 가격 | 출력 가격 | 컨텍스트 | 모달리티 |
| :-: | :-: | :-: | :-: |
| $0.510 / 1M | $0.740 / 1M | 131,072 | 텍스트 → 텍스트 |
...
<CardGroup cols={3}>
  <Card title="Air API Playground" icon="play" href="https://ap-1.aieev.cloud:3007/ko/models/llama3.3-70b-instruct">
    플레이그라운드에서 모델을 체험하세요.
  </Card>
