...
<Warning>
  이 모델은 서비스가 종료되었습니다. 후속 모델인 [Qwen3.6-35B-A3B](/models/ko/qwen3-6-35b-a3b)를 사용하세요.
</Warning>
...
- 텍스트 및 이미지 입력을 지원하는 멀티모달 능력 (요청당 최대 4장, 초과 전송 시 400 에러)
- 강력한 다국어 이해 및 생성
...
response = requests.post(
    "https://external.aieev.cloud:5000/ai/api/v1/chat/completions",
    headers={
...
```bash cURL
curl --request POST \
  --url https://external.aieev.cloud:5000/ai/api/v1/chat/completions \
