...
<Info>
  **Model ID:** `meta-llama/meta-llama-3.3-70b-instruct` | **Endpoint ID:** `llama3-3-70b-instruct` | **Parameters:** 70B | **Released:** 2024-12-06
</Info>
...
<CardGroup cols={3}>
  <Card title="Air API Playground" icon="play" href="https://ap-1.aieev.cloud:3000/models/meta-llama%2Fmeta-llama-3.3-70b-instruct">
