...
- **Time-based scaling**: Schedule minimum replica counts or enable/disable autoscaling by time of day. Match traffic patterns and reduce idle costs automatically.
