...
<AccordionGroup>
  <Accordion title="What should I do first to start using AirCloud?">
    Start by creating an account, generating a secret key, and either deploying a container via **Air Container** or calling an AI model via **Air API**. The [Quickstart](/docs/get-started/quickstart) guide walks through the full process.
  </Accordion>

  <Accordion title="Are credits required to use AirCloud?">
    Yes. AirCloud uses a prepaid credit system. Credits are shown with the unit **C**, and for organizations in the KRW region 1 C equals KRW 1 of supply price. You need to top up credits before you can deploy containers or call APIs.
  </Accordion>
  ...
  <Accordion title="Where can I get help?">
    Check the [Troubleshooting](/docs/air-container/troubleshooting) guide for common issues. For direct support, use the chat widget in the console or contact us at [support@aieev.com](mailto:support@aieev.com).
  </Accordion>
</AccordionGroup>