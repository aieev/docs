...
| **Replicas** | The number of container replicas to run concurrently. When Autoscaling is enabled, AirCloud automatically scales between the configured minimum and maximum values. |
| **Persistent Storage** | Persistent storage that remains available even if the container is stopped or restarted. Up to **30 GB** can be allocated. |
...
![Aircontainer](/images/aircontainer.png)

### 3. Choose a Deployment Method

Select how you want to create your container.

![Create Container1](/images/create-container1.png)
...
![Container Setting](/images/container-setting.png)

### 2. Configure Resources

Expand the **Resources** section to select the infrastructure option and GPU model.

![Container Resource](/images/container-resource.png)
...
| **Registry Access** | **Public** images require no authentication. **Private** registries require a username and password (or access token). |
