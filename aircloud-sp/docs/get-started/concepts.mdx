...
This document introduces the core concepts you should understand when getting started with AirCloud.

<Info>
  If you are new to AirCloud, we recommend reviewing the [Quickstart](/docs/quickstart) first to understand the overall flow.
</Info>
...
AirCloud Zero and AirCloud Plus are two infrastructure options provided by AirCloud. They differ fundamentally in how nodes are organized and how resources are allocated.
...
<Columns cols={2}>
  <Card title="Quickstart" icon="play-circle" href="/docs/quickstart" cta="Get started" arrow="true">
    Walk through the full flow from account creation to first use.
  </Card>

  <Card title="Organizations and Billing" icon="building" href="/docs/get-started/organizations-and-billing" cta="Learn the structure" arrow="true">
    Learn about the Organization/Project structure and billing concepts.
  </Card>
