...
1. **Create an Organization** An Organization name can represent a company, lab, or project. You can also add collaborators to an Organization. <img src="/docs/images/quickstart/quickstart-05.png" alt="Onboarding - Create organization" />
   <Note>
...
2. **Create a Project** A Project can represent a service you are building or a development effort. You can create multiple endpoints within a single Project. <img src="/docs/images/quickstart/quickstart-08.png" alt="Create a project" />
3. **Add credit** _(optional)_ After completing onboarding, go to the console to follow the first-time guide and start using the service. <img src="/docs/images/quickstart/quickstart-07.png" alt="Add credit" />
