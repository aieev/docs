...
If your application already uses the OpenAI SDK, you only need to replace two settings. See the [OpenAI Compatible API](/docs/air-api/openai-compatible-api) page for the full quick start and code samples.
...
![Code Sample Eng](/images/code-sample-eng.png)
...
For chat completion and embedding examples, see the [OpenAI Compatible API](/docs/air-api/openai-compatible-api) page. Air API also supports text-to-speech through the OpenAI SDK's audio endpoint, shown below.
...
<Columns cols={2}>
  ...
  <Card title="OpenAI Compatible API" icon="arrow-left-right" href="/docs/air-api/openai-compatible-api" cta="View Documentation" arrow="true">
