...
| :-- | :-- | :-- | :-: | :-: |
| Qwen3.6-35B-A3B | `qwen/qwen3.6-35b-a3b` | chat | ✅ | ✅ |
...
<Note>
  Streaming is currently supported on **Qwen3.6-35B-A3B**, **Qwen3.5-9B**, and **Qwen3-32B**. **Llama3-70B** support is coming soon.
</Note>

## Tool Calling (Function Calling)

Lets the model call external functions or services. Supported on **Qwen3.6-35B-A3B** and **Qwen3.5-9B**. **Qwen3-32B** and **Llama3-70B** support is coming soon.
