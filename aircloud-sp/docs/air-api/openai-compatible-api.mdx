...
<Note>
  Streaming is currently supported on **Qwen3.6-35B-A3B**, **Qwen3.5-9B**, **Qwen3-32B**, **Llama3.3-70B**, and **DeepSeek V4 Flash**.
</Note>

## Tool Calling (Function Calling)

Lets the model call external functions or services. Supported on **Qwen3.6-35B-A3B**, **Qwen3.5-9B**, **Qwen3-32B**, **Llama3.3-70B**, and **DeepSeek V4 Flash**.
...
Qwen chat models and DeepSeek V4 Flash support reasoning (thinking). The reasoning trace is returned separately from the final answer (`content`) in the `reasoning` field.
