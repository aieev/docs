...
3. **Air Cloud preference** — a toggle on the console's **Notifications → Settings** tab.
...
Open **Notifications → Settings** in the console and turn on the **Desktop** channel for the events you want. The first time you enable it, your browser will prompt you to allow notifications from Air Cloud.

The settings tab is a matrix of events by channel, so you can pick exactly which events reach your desktop. See [Notifications](/docs/console/notifications) for the full list.
