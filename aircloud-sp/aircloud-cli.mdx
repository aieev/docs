...
icon: "terminal"
slug: "/docs/ko/air-container/access-and-connect/aircloud-cli"
---
...
이미지 준비, SSH 키 등록, 접속 예시는 [SSH로 접속하기](/docs/ko/air-container/access-and-connect/ssh-access) 문서를 참고하세요.
